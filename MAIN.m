...
opt=initOpt('template','truncated tetrahedron','analysis','result','readHingeFile','off',...
            ...
            'gethistory', 'off',...
            'constrEdge','on','constrFace','off','constAnglePerc',0.99,... 
            'Khinge',0.001,'Kedge',3,'Kdiag',3,'Kface',1,'KtargetAngle',100,...
            'maxStretch', 0.3,...
            'maxHinges',inf,'minHinges',0);    %Only work when readHingeFile is 'on'

opt.saveFile = strcat('/',date,'_EnergyAllAnglesFaceBend_3_24');
