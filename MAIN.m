...
switch SimCase
    case 1
        opt=initOpt('inputType','individual',... 
                    'template','tetrahedron','onlyUnitCell', 'on',...
                    'plot','selectHinges','createFig', 'on', 'showFig', 'off',...
                    'interval', 1,'saveFig','on','periodic','off','figDPI',300,...
                    'saveMovie', 'off', 'safeMovieAntiAlias', 0,...
                    'folAlgor', 'sqp','relAlgor', 'sqp','readAngFile', 'on',...
                    'gradDescStep', 1e-1, 'gradDescTol', 1e-9,...
                    'constrFace','off','constrEdge','off','gethistory', 'on',...
                    'Khinge',0.001,'Kedge',10,'Kface',10,'KtargetAngle',1,...
                    'stepkHinge', 1, 'stepkTargetAngle', 3, 'stepkEdge', 1,...
                    'relInterval', 1, 'constAnglePerc',1,...
