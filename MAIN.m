...
opt.options=optimoptions('fmincon','GradConstr','on','GradObj','on',...
                         'tolfun',1e-4','tolx',1e-4, 'tolcon',1e-5,...
                         'Display','off','DerivativeCheck','off',...
                         'maxfunevals',100000, 'MaxIterations', 300,...
