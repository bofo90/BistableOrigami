...
opt=initOpt('template','SingleVertex','numVert', 4,'vertexType', "2CFF",...
            'tessellationType', '25','xrep', 1, 'yrep', 2, 'periodic', 'off',...
            ...
            'Khinge',10^-1.5,'Kedge',1,'Kdiag',1,'Kface',100,'KtargetAngle',5000,...
...
%         kap = opt.Khinge; %[kap kap*10 kap*100]; %[10^-3, logspace(-1,0,2)];% 
        xrep = 10:25;% opt.xrep; %only used when having tessellations
