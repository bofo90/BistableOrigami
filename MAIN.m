...
opt=initOpt('inputType', 'origami','template','SquareTiling',...
            'numUnitCell', 3,'ratio', 8,'layers', 1,...
            'analysis','savedata','readHingeFile','on',...
...
% opt.saveFile = strcat('/',date,'_ThreeLayer');
opt.saveFile = strcat('/','23-Apr-2019_OneLayer_8rat');
tic;

opt.plotAngles = [21 21];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%BUILD
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
