...
switch SimCase
    case 1
        opt=initOpt('inputType','individual', 'plot','result',... 
                    'template','truncated tetrahedron','onlyUnitCell', 'off',...
