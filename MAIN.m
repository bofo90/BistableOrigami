...
opt=initOpt('template','truncated tetrahedron','analysis','result','readHingeFile','off',...
            ...
            'Khinge',0.001,'Kedge',3,'Kdiag',1,'Kface',100,'KtargetAngle',100,...
            'maxStretch', 0.3,...
            'maxHinges',inf,'minHinges',0);    %Only work when readHingeFile is 'on'

opt.saveFile = strcat('/',date,'_Energylandscape_24to3');
% opt.saveFile = strcat('/','07-Feb-2018_Energylandscape_24to3');
